  ...
  const sections: TermsSection[] = useMemo(() => [
    {
      ...
      badge: "The Agreement",
      summary: "By creating an account or using StudyMind AI, you agree to these legal terms. Please read them carefully before using our platform.",
      content: (
        <div className="space-y-4">
          <p>
            Welcome to <strong>StudyMind AI</strong> (referred to as "we", "us", "our", or the "Platform"). These Terms and Conditions govern your access to and use of our website, AI study assistants, generated study guides, practice quizzes, and all other services we offer.
          </p>
          <p>
            By creating an account, subscribing to our plans, or using any part of StudyMind AI, you represent that you are at least 13 years of age (or have explicit parental/guardian consent) and that you agree to be bound by these Terms.
          </p>
          <p>
            If you do not agree to these Terms, you are prohibited from using or accessing our platform, and must immediately cease all use of our services.
          </p>
        </div>
      )
    },
    {
      ...
      badge: "Your Account",
      summary: "You are responsible for keeping your login credentials safe and ensuring your account activity complies with academic integrity guidelines.",
      content: (
        <div className="space-y-4">
          <p>To access full platform features (including saving study guides, tracking quiz scores, and using the AI doubt solver), you must sign up via our secure authorization flow.</p>
          <ul className="list-disc pl-5 space-y-2">
            <li>
              <strong>Account Security:</strong> You are solely responsible for maintaining the confidentiality of your session tokens and credentials. You agree to notify us immediately of any unauthorized use.
            </li>
            <li>
              <strong>Academic Integrity:</strong> StudyMind AI is designed to assist and enhance your learning, not to replace original thought or enable cheating. We expect all students and self-learners to use our guides, doubt solver, and quizzes in accordance with their respective school's honor codes.
            </li>
            <li>
              <strong>Account Termination:</strong> We reserve the right to suspend or terminate accounts that engage in fraudulent behavior, automated scraping, or malicious attempts to bypass system limits.
            </li>
          </ul>
        </div>
      )
    },
    {
      ...
      summary: "You own the custom study guides and quiz inputs you create, but please be aware that AI-generated information can occasionally contain errors.",
      content: (
        <div className="space-y-4">
          <h4 className="font-semibold text-slate-800 dark:text-slate-200 mt-2">A. Ownership of Output</h4>
          <p>
            You retain all ownership rights to the source materials, notes, and topics you upload or input. We do not claim any proprietary rights over the personalized study guides, flashcards, or quizzes generated for you by StudyMind AI. You are free to export, print, and study them as you wish.
          </p>
          <h4 className="font-semibold text-slate-800 dark:text-slate-200 mt-2">B. The Nature of AI (Accuracy Disclaimer)</h4>
          <p>
            Our services utilize Google Gemini API models to deliver custom explanations and answer study questions. While we employ state-of-the-art prompt filtering, AI models are subject to "hallucinations" and can occasionally generate inaccurate or outdated information.
          </p>
          <p className="text-sm text-slate-500 dark:text-slate-400 border-l-2 border-amber-500 pl-3">
            Always double-check critical formulas, definitions, and facts against your textbook or verified course curriculum. StudyMind AI is an educational study aid, not a certified textbook.
          </p>
        </div>
      )
    },
    {
      ...
      badge: "Payments",
      summary: "Paid subscriptions renew automatically. You can cancel easily at any time directly through your billing settings page.",
      content: (
        <div className="space-y-4">
          <p>We offer both free tiers and premium subscription levels. If you opt for a premium plan:</p>
          <ul className="list-disc pl-5 space-y-2">
            <li>
              <strong>Automatic Renewal:</strong> Subscription fees are charged on a recurring basis (monthly or annually) depending on your selected tier. Your card will be billed automatically until you cancel.
            </li>
            <li>
              <strong>Cancellations:</strong> You can cancel your subscription at any time. Your premium benefits will continue until the end of your current billing cycle, and no further charges will be made.
            </li>
            <li>
              <strong>Refunds:</strong> Refund requests are evaluated on a case-by-case basis. If you believe you were charged in error, please reach out to our support team within 14 days of the charge.
            </li>
          </ul>
        </div>
      )
    },
    {
      ...
      badge: "Our Brand",
      summary: "We own the StudyMind AI brand, platform code, interface design, and logo. Please don't copy or reverse engineer our service.",
      content: (
        <div className="space-y-4">
          <p>
            The StudyMind AI name, brand assets, custom user interface, logos, graphics, website design, database structures, and proprietary algorithms are protected by copyright, trademark, and other intellectual property laws.
          </p>
          <p>
            These Terms grant you a limited, non-exclusive, non-transferable license to access and use the platform for your own personal, educational studying. You may not:
          </p>
          <ul className="list-disc pl-5 space-y-2">
            <li>Copy, modify, or reverse-engineer our source code or platform files.</li>
            <li>Use automated bots or crawlers to harvest user content or scrape our structured database.</li>
            <li>Repackage, white-label, or sell our AI-powered study guides as a separate commercial platform.</li>
          </ul>
        </div>
      )
    },
    {
      ...
      badge: "Legal Limits",
      summary: "We provide our study tools 'as-is' and do not guarantee specific academic results, test grades, or school admission outcomes.",
      content: (
        <div className="space-y-4">
          <p>
            STUDYMIND AI IS PROVIDED ON AN "AS IS" AND "AS AVAILABLE" BASIS. TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, WE DISCLAIM ALL WARRANTIES, EXPRESS OR IMPLIED.
          </p>
          <p>
            In no event shall StudyMind AI, its developers, or its affiliates be liable for any academic failures, low test grades, exam disqualifications, missed assignments, or secondary losses arising from the use of our educational tools.
          </p>
          <p>
            We do not guarantee 100% uninterrupted platform uptime, as external API interruptions (such as Google Gemini, Vercel hosting, or database services) may occasionally affect server availability.
          </p>
        </div>
      )
    },
    {
      ...
      badge: "Updates",
      summary: "We may update these terms occasionally as we add new features. Continued use of our app means you agree to the updated terms.",
      content: (
        <div className="space-y-4">
          <p>
            We reserve the right to revise or modify these Terms and Conditions at any time. When we make changes, we will update the "Last Updated" date at the top of this page.
          </p>
          <p>
            For substantial changes, we will make reasonable efforts to notify you (e.g., via a dashboard notification or email). Your continued use of StudyMind AI after any changes take effect constitutes your acceptance of the newly revised Terms.
          </p>
        </div>
      )
    }
          ...
          <div className="text-center max-w-3xl mx-auto">
            ...
            >
              ...
              <p className="text-lg text-slate-600 dark:text-slate-400 leading-relaxed mb-8">
                Welcome to StudyMind AI. By using our platform, you agree to these transparent terms that safeguard your rights and academic journey.
              </p>
          ...
          <aside className="lg:sticky lg:top-28 col-span-1 space-y-6">
            ...
            <div className="bg-gradient-to-br from-blue-600 to-indigo-700 text-white rounded-2xl p-6 shadow-md relative overflow-hidden group">
              ...
              <p className="text-sm text-blue-100 leading-relaxed mb-4">
                Have compliance questions, payment inquiries, or feedback regarding our legal terms?
              </p>
              <a
                href="/contact"
                ...
                {filteredSections.length > 0 ? (
                  ...
                  >
                    ...
                    <p className="text-slate-500 dark:text-slate-400 max-w-md mx-auto text-sm">
                      We couldn't find any legal sections matching "{searchQuery}". Try searching for ownership, billing, liability, or updates.
                    </p>
                    <button
                      onClick={() => setSearchQuery("")}
