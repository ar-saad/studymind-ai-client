...
const topics = ["Quantum Physics", "World War II", "Machine Learning", "Roman Empire", "Neuroscience", "Blockchain"];
      ...
      <div className="container mx-auto px-4 md:px-8 max-w-7xl">
        <div className="flex flex-col items-center text-center">
          ...
          >
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-indigo-600 to-teal-500 animate-gradient">
              Master It Faster.
            </span>
          </motion.h1>
          ...
          >
            Type any topic, get an AI-generated study guide, quiz yourself, and track your progress. The ultimate companion for modern learners.
          </motion.p>
          ...
          >
            <Button size="lg" className="bg-blue-600 hover:bg-blue-700 text-white h-14 px-10 text-lg rounded-full shadow-lg shadow-blue-500/25 group">
              <Link href="/register" className="flex items-center gap-2">
                Start Learning Free
                <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </Link>
            </Button>
            <Button size="lg" variant="outline" className="h-14 px-10 text-lg rounded-full border-2 hover:bg-slate-50 dark:hover:bg-slate-900">
          ...
          >
            <p className="text-sm text-slate-500 font-bold uppercase tracking-widest mb-8">What do you want to learn today?</p>
              ...
              {topics.map((topic, index) => (
                <motion.div
                  ...
                  animate={{
                    ...
                    backgroundColor: activeTopicIndex === index ? "rgba(37, 99, 235, 0.1)" : "transparent",
                    borderColor: activeTopicIndex === index ? "rgba(37, 99, 235, 0.5)" : "rgba(226, 232, 240, 1)",
                  }}
